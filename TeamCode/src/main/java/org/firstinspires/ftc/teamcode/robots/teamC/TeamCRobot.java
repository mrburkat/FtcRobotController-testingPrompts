...
/**
 * Team C robot composition skeleton.
 *
 * <p>This class starts from the shared baseline hardware and subsystem
 * composition so Team C can compile and test lifecycle code before
 * robot-specific wiring, mechanisms, and constants are finalized.</p>
 */
public class TeamCRobot extends Robot implements AutonomousDriveControl, AutonomousIntakeControl {
    ...
    /**
     * Creates Team C's robot using the standard shared hardware composition.
     */
    public TeamCRobot() {
    ...
    /**
     * Creates Team C's robot using supplied hardware wrappers.
     *
     ...
     */
    public TeamCRobot(RobotHardware robotHardware) {
        if (robotHardware == null) {
            throw new IllegalArgumentException("RobotHardware cannot be null.");
        }

        this.robotHardware = robotHardware;
        // TODO: Team C may replace shared wrappers when final wiring and motor
        ...
        // TODO: Add or swap Team C-specific subsystems here as unique
    ...
    /**
     * Initializes Team C hardware and registered subsystems.
     *
